                    ...
                    <li className="nav-item">
                        <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
                            ...
                            <DropdownMenu className="dropdown-menu-right">
                                ...
                                <DropdownItem><i className="fa fa-bell-o"></i> Updates<span
                                ...
                                <DropdownItem onClick={(event) => this.logout(event)}><i className="fa fa-lock"></i> Logout</DropdownItem>

                            </DropdownMenu>
                        </Dropdown>
                    </li>
                    <li className="nav-item d-md-down-none">
                        <a className="nav-link navbar-toggler aside-menu-toggler" onClick={this.asideToggle}
                           href="#">&#9776;</a>
                    </li>
                </ul>
            </header>
